...
async def verify_phase2():
    ...
    try:
        ...
        # Check methods exist
        methods = ['upload_voice_sample', 'generate_presigned_url', 'delete_voice_sample', 'get_file_metadata']
    ...
    try:
        ...
        expected_endpoints = ['/', '/upload', '/{voice_id}/clone', '/{voice_id}/set-default', '/{voice_id}', '/system']
