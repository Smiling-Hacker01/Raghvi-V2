...
from sqlalchemy import Column, DateTime, String, Float, Integer, Boolean, Uuid, Index
...
class UserSubscription(Base):
    ...
    def __repr__(self) -> str:
        return f"<UserSubscription user_id={self.user_id} plan={self.plan_id} expires={self.expires_at}>"
