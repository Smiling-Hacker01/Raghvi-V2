...
class TestAIProviderChain:
    ...
    def test_build_chain_all_available(self, mock_gemini_cls, mock_openai_cls, mock_get_settings, chain_settings):
    ...
    @patch("app.services.ai.providers.openai.OpenAIAdapter")
    @patch("app.services.ai.providers.gemini.GeminiAdapter")
    async def test_send_message_success_primary(self, mock_gemini_cls, mock_openai_cls, mock_get_settings, chain_settings):
        mock_get_settings.return_value = chain_settings
    ...
    @patch("app.services.ai.providers.openai.OpenAIAdapter")
    @patch("app.services.ai.providers.gemini.GeminiAdapter")
    async def test_send_message_failover(self, mock_gemini_cls, mock_openai_cls, mock_get_settings, chain_settings):
        mock_get_settings.return_value = chain_settings
    ...
    @patch("app.services.ai.providers.openai.OpenAIAdapter")
    @patch("app.services.ai.providers.gemini.GeminiAdapter")
    async def test_send_message_all_fail(self, mock_gemini_cls, mock_openai_cls, mock_get_settings, chain_settings):
        mock_get_settings.return_value = chain_settings
